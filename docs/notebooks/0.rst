...
============================================
    ...
    To qualify as a “low-access community,” at least 500 people and/or
    at least 33 percent of the census tract's population must reside
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    PCT\_LACCESS\_POP10 (2010)

    PCT\_LACCESS\_POP15 (2015)
...
.. code:: ipython3
    ...
    dataset.to_pickle(Path.joinpath(project_dir, "data/processed/initial_model.pickle"))
...
.. code:: ipython3
    ...
    data_dictionary.to_pickle(Path.joinpath(project_dir, "data/processed/data_dictionary.pickle"))
